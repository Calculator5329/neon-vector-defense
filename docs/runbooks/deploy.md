...
**The build step is NOT optional.** Hosting uploads `dist/` as-is and there is no
...
Always ship hosting + rules + functions together, because the replay schema couples
